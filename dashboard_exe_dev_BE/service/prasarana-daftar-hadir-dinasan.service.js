...
const repository = __importStar(require("../repository/prasarana-daftar-hadir-dinasan.repository"));
...
const saveDetailFile = async (req) => {
    ...
    try {
        ...
        req.body.menu = 'Daftar Hadir Dinasan';
        req.body.description = 'Insert Daftar Hadir Dinasan';
...
const deleteDetailFile = async (req) => {
    ...
    try {
        ...
        if (getData) {
            ...
            req.body.menu = 'Daftar Hadir Dinasan';
            req.body.description = 'Delete Daftar Hadir Dinasan';
