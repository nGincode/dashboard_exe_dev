...
const repository = __importStar(require("../repository/prasarana-serah-terima-dinasan.repository"));
...
const saveDetailFile = async (req) => {
    ...
    try {
        ...
        req.body.menu = 'Serah terima Dinasan';
        req.body.description = 'Insert Serah terima Dinasan';
...
const deleteDetailFile = async (req) => {
    ...
    try {
        ...
        if (getData) {
            ...
            req.body.menu = 'Serah terima Dinasan';
            req.body.description = 'Delete Data Serah terima Dinasan';
