...
exports.getDetailFileAYear = exports.getDataByYear = exports.deleteDetailFile = exports.saveDetailFile = exports.getDetailFile = exports.deleteFile = exports.getFile = exports.uploadFile = exports.Find = exports.Insert = exports.All = void 0;
const service = __importStar(require("../service/subsidi.service"));
...
const getDetailFileAYear = async (req, res) => {
    let result = await service.getDetailFileAYear(req);
    let status;
    if (result.code == "00") {
        status = 200;
    }
