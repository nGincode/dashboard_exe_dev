...
const Insert = async (data) => {
    let result = await db_config_1.default.withSchema("prasarana").table("data_kelambatan").insert(data);
    return result;
};
exports.Insert = Insert;
const InsertHistory = async (data) => {
    let result = await db_config_1.default.withSchema("history").table("pra_data_kelambatan").insert(data);
    return result;
};
