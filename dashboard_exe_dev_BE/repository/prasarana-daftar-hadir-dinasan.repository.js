...
const Insert = async (data) => {
    let result = await db_config_1.default.withSchema("prasarana").table("daftar_hadir_dinasan").insert(data);
    return result;
};
exports.Insert = Insert;
const InsertHistory = async (data) => {
    let result = await db_config_1.default.withSchema("history").table("pra_daftar_hadir_dinasan").insert(data);
    return result;
};
